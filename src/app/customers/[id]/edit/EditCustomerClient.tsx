...
export default function EditCustomerClient({
    ...
    const formSections = useMemo(() => getFormSections(serviceNames), [serviceNames]);
        ...
        fetch(`/api/customers/${customerId}`)
            ...
            .then((data: CustomerData & { error?: string }) => {
                if (data.error) {
                    ...
                    // Explicitly map attribute_label if present
                    if (data.attribute_label) {
                        mapped.attribute_label = data.attribute_label;
                    }
                    setFormData(mapped);
                }
                setIsLoading(false);
