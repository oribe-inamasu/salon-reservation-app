...
const DEFAULT_COURSES: ServiceCourse[] = [
    { id: "c1", name: "総合鍼灸コース 60分", duration: 60, price: 6500, category: "鍼治療" },
    { id: "c2", name: "美容鍼スタンダード 45分", duration: 45, price: 5500, category: "美容鍼" },
    { id: "c3", name: "クイックマッサージ 30分", duration: 30, price: 3500, category: "マッサージ" },
];
